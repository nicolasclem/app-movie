...
<Box sx={{ m:2, display: "flex", justifyContent: "center", p: 2 }}>
<Grid container sx={{ maxWidth: 1200 }}>
    ...
    <Paper elevation={0}  sx={{backgroundColor:"transparent" , color:"var(--bg-grey-100)"}} >
            ...
            <Typography variant="body2"  sx={{mt: 2}}>Director : {infoMovie.directorName?infoMovie.directorName.name:"Desconocido"}</Typography>

            <Typography variant="body2" sx={{mt: 2}}>{movieId.overview}</Typography>
                {infoMovie.video?
                <Box xs={12} sx={{ mt: 2 }}>
                  <Typography variant="body1" sx={{mt: .5}}>Oficial Trailer</Typography>
                  <iframe
                    width="560"
                    height="315"
      ...
      <Grid container sx={{ maxWidth: 1200 }}>
        ...
        <CardMedia
            ...
            image={
             movieId.poster_path
                ? `http://image.tmdb.org/t/p/w780/${movieId.poster_path}`
                : "no hay imagen"
            }
            sx={{ objectFit: "contain" }}
          />
        ...
        <Grid item xs={12} sm={8} sx={{ p: 1 }}>
          <Paper elevation={5} sx={{ p: 2, position: "relative" }}>
           ...
           <Typography variant="body1" sx={{mt: .5}}>
              Actors:<br/> {
              infoMovie.cast.map(actor=>(actor?<Typography variant="body2">{actor.name}</Typography>:"no hay actor"))}
            </Typography> 
            <br />
            <Typography variant="body2">{movieId.overview}</Typography>
